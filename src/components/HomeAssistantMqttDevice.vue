  ...
  <q-card>
    <q-card-section>
      <q-toolbar>
        ...
        <q-btn label="view messages" flat color="primary" @click="showDiscovery" />
        <q-btn
          flat
          label="publish"
          color="secondary"
    ...
    <q-card-section>
      <monaco-editor v-model="deviceJson" filetype="device" style="min-height: 200px" />
    ...
    <q-card-section v-for="(entity, index) in props.device.entities" :key="index">
