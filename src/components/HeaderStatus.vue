<template>
  <div v-if="!mqttStore.isConnected" class="flex q-my-sm">
    mqtt: not connected
  </div>
  <div v-else class="flex q-my-sm">
    ...
    ></q-btn>
    <q-btn
      v-if="tasmotaStore.devicesCount > 0"
      icon="img:logos/tasmota.svg"
      round
      flat
      size="md"
    >
    ...
    <q-btn v-else icon="img:logos/zigbee2mqtt.png" round flat size="md">
    </q-btn>
    <q-btn
      flat
      label="disconnect"
